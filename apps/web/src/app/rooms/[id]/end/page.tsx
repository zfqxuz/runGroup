      ...
      {activeGame === null ? (
        <section className="rounded-xl border border-amber-400/30 bg-amber-400/10 p-5">
          ...
          <form action={endGameWithAdvancementsAction} className="mt-4">
            ...
            <button
              type="submit"
              className="rounded-lg bg-sakura-500 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-sakura-400"
            >
              结束并重置房间
            </button>
          </form>
          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            {pendingRows.length === 0 ? null : (
              <form action={resolveGrowthCheckAction}>
                ...
                <button
                  type="submit"
                  className="rounded-lg bg-amber-400 px-4 py-2 text-sm font-medium text-white transition hover:bg-amber-300"
                >
