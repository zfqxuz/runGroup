    ...
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col gap-6 px-6 py-12">
      ...
      {canEdit ? (
        <form action={saveModuleAction} className="flex flex-col gap-5 rounded-xl border border-white/10 bg-ink-800/50 p-5">
          ...
          <div>
            <button type="submit" className="rounded-lg bg-sakura-500 px-5 py-2.5 text-sm font-medium text-ink-onAccent transition hover:bg-sakura-400">保存正文与元信息</button>
          </div>
        </form>
      ) : canViewFull ? (
