...
async function main(): Promise<void> {
  ...
  const cards: SeedCard[] = [
    ...
    { id: "seed-card-rare", type: "SPELLCARD", name: "演示 · 梦想封印", subtitle: "稀有", description: "用于验证 RARE 边框与角色装备", rarity: "RARE", equipped: true, isTemplate: true, stats: { mode: "DECLARATION", danmaku: "演示用弹幕", mpCost: 10, hpRatio: 1, durationTicks: 720, clearTargets: "ALL", enhanceType: "DANMAKU", enhanceValue: 1.5 } },
    { id: "seed-card-epic", type: "SPELLCARD", name: "演示 · 梦想天生", subtitle: "史诗", description: "用于验证 EPIC 边框", rarity: "EPIC", stats: { mode: "DECLARATION", danmaku: "演示用弹幕", mpCost: 30, hpRatio: 1, durationTicks: 900, clearTargets: "OTHERS_ONLY", enhanceType: "SPELL", enhanceValue: 2 } },
