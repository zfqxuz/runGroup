...
| `app-auth-register-page-tsx-3` | 用户名（登录用，字母数字下划线连字符） |  |
...
| `app-auth-register-page-tsx-9` | 注册成功，但自动登录失败，请手动登录 |  |
...
| `app-admin-magic-roomid-page-tsx-3` | 控制是否把团本 structured.magic 合并进 Room.ruleOverride。关闭后最终规则包不会带团本魔法。 |  |
| `app-admin-magic-roomid-page-tsx-4` | 去准备页 → |  |
| `app-admin-magic-roomid-page-tsx-5` | 2. 团本 structured.magic |  |
| `app-admin-magic-roomid-page-tsx-6` | 模板/导出的团本里如果有 spells 数据，会在这里显示；没有则说明导入时没有生成结构化魔法。 |  |
| `app-admin-magic-roomid-page-tsx-7` | 从团本重新同步 |  |
| `app-admin-magic-roomid-page-tsx-8` | 查看团本管理 → |  |
| `app-admin-magic-roomid-page-tsx-9` | 由「启用魔法规则 / 从团本同步」写入；如果 enabled=false，它会覆盖绑定规则包里的魔法配置。 |  |
| `app-admin-magic-roomid-page-tsx-10` | 4. 最终生效规则包 |  |
| `app-admin-magic-roomid-page-tsx-11` | 当前没有生效法术。 |  |
...
| `app-admin-magic-roomid-page-tsx-16` | Room.ruleOverride 原始 JSON |  |
...
| `app-admin-magic-roomid-page-tsx-24` | · 没有 structured.magic |  |
...
| `app-admin-magic-effects-page-tsx-3` | 这里是底层可枚举的基础能力。单个法术 = 从下面任选若干效果，按顺序组合成 |  |
| `app-admin-magic-effects-page-tsx-4` | 数组。 |  |
| `app-admin-magic-effects-page-tsx-5` | 组合示例 |  |
| `app-admin-magic-effects-page-tsx-6` | 下面一条法术同时具有「伤害 + 眩晕 + 护甲」，战斗引擎会按数组顺序依次结算。 |  |
...
| `app-admin-magic-page-tsx-3` | 查看每个房间的魔法配置链路：房间开关 → 团本 structured.magic → Room.ruleOverride → 最终生效规则包。 |  |
| `app-admin-magic-page-tsx-4` | 查看支持的基础魔法效果 → |  |
| `app-admin-magic-page-tsx-5` | 已开启魔法开关的房间 |  |
| `app-admin-magic-page-tsx-6` | 团本中解析出魔法的房间 |  |
| `app-admin-magic-page-tsx-7` | selected module structured.magic 非空 |  |
| `app-admin-magic-page-tsx-8` | 开关 + 有法术数据 |  |
| `app-admin-magic-page-tsx-9` | 还需要规则包版本 / 冲突检查确认最终生效 |  |
...
| `app-admin-magic-page-tsx-19` | 查看链路 |  |
| `app-admin-magic-page-tsx-20` | 内置 / 未绑定 |  |
...
| `app-admin-modules-page-tsx-14` | 平台/无主 |  |
...
| `app-admin-page-tsx-2` | 平台数据、规则包与 AI 导入配置的总控台。 |  |
...
| `app-admin-page-tsx-14` | 创建、版本、发布、绑房与导入导出 |  |
| `app-admin-page-tsx-15` | 魔法管理 |  |
| `app-admin-page-tsx-16` | 逐房间查看魔法链路：开关 / 团本 / 覆盖 / 最终生效 |  |
| `app-admin-page-tsx-17` | 游戏局 |  |
| `app-admin-page-tsx-18` | 查看全站开局与结束状态 |  |
| `app-admin-page-tsx-19` | 系统设置 |  |
| `app-admin-page-tsx-20` | DeepSeek 等平台级配置 |  |
...
| `app-admin-page-tsx-31` | DB 管理的规则包 |  |
...
| `app-admin-rulepacks-packid-page-tsx-2` | 导出 JSON |  |
| `app-admin-rulepacks-packid-page-tsx-3` | 归档 |  |
| `app-admin-rulepacks-packid-page-tsx-4` | 发布 |  |
| `app-admin-rulepacks-packid-page-tsx-5` | 删除整个规则包（无绑定时可用） |  |
| `app-admin-rulepacks-packid-page-tsx-6` | 魔法规则 |  |
| `app-admin-rulepacks-packid-page-tsx-7` | 该版本没有 `magic` / `spells`。房间里的魔法通常来自团本 `structured.magic`， 也可以在下面的完整 RulePack JSON 里加入 `magic` 字段后发布新版本。 |  |
| `app-admin-rulepacks-packid-page-tsx-8` | 去魔法管理查看房间生效链路 → |  |
...
| `app-admin-rulepacks-packid-page-tsx-14` | 新版本默认草稿。发布后可在“绑定房间”中选择。 |  |
| `app-admin-rulepacks-packid-page-tsx-15` | 版本号 |  |
| `app-admin-rulepacks-packid-page-tsx-16` | 备注 |  |
| `app-admin-rulepacks-packid-page-tsx-17` | 规则集配置（表单 / JSON 双模式） |  |
| `app-admin-rulepacks-packid-page-tsx-18` | 保存草稿版本 |  |
| `app-admin-rulepacks-packid-page-tsx-19` | 导入 JSON 版本 |  |
| `app-admin-rulepacks-packid-page-tsx-20` | 上传一个完整 RulePack JSON 文件，作为新草稿版本落库。 |  |
| `app-admin-rulepacks-packid-page-tsx-21` | JSON 文件 |  |
...
| ID | 原文 | 你的修改 |
|---|---|---|
| `app-admin-rulepacks-packid-versions-versionid-ex-1` | 未登录 |  |
...
| `app-admin-rulepacks-page-tsx-28` | 还没有数据库规则包，点击右上角“同步内置规则包”开始。 |  |
...
| `app-admin-system-page-tsx-3` | 平台级配置，保存在 SystemSetting 表，AI 团本导入会优先读取这里的值。 |  |
| `app-admin-system-page-tsx-4` | 设置已保存。 |  |
| `app-admin-system-page-tsx-5` | n8n 团本解析工作流 |  |
| `app-admin-system-page-tsx-6` | n8n 容器内部持有 DEEPSEEK_API_KEY，应用不再直接调用模型；n8n 端口默认只绑定 127.0.0.1。 |  |
| `app-admin-system-page-tsx-7` | DeepSeek 回退接入 |  |
| `app-admin-system-page-tsx-8` | 仅当 N8N_MODULE_PARSE_URL 为空时，应用才回退到 DeepSeek 直连。 |  |
| `app-admin-system-page-tsx-9` | 保存 |  |
| `app-admin-system-page-tsx-10` | 暂无设置项。 |  |
| `app-admin-system-page-tsx-11` | DeepSeek 默认模型 |  |
| `app-admin-system-page-tsx-12` | deepseek-flash 支持图片视觉输入，推荐作为默认模型；deepseek-v4-pro 为文本推理模型。 |  |
| `app-admin-system-page-tsx-13` | 单次 AI 导入最大文件数 |  |
| `app-admin-system-page-tsx-14` | JSON 数字，例如 30。 |  |
| `app-admin-system-page-tsx-15` | DeepSeek 直连（旧回退路径） |  |
| `app-admin-system-page-tsx-16` | 已从环境变量 DEEPSEEK_API_KEY 读取 |  |
| `app-admin-system-page-tsx-17` | 未配置（n8n 正常时可不配置） |  |
...
| ID | 原文 | 你的修改 |
|---|---|---|
| `app-api-modules-moduleid-assets-route-ts-1` | 未登录 |  |
| `app-api-modules-moduleid-assets-route-ts-2` | 请求格式不合法 |  |
...
| `app-api-modules-moduleid-assets-route-ts-7` | 资源超过 20MB 上限 |  |
...
| ID | 原文 | 你的修改 |
|---|---|---|
| `app-api-modules-ai-import-route-ts-1` | 未登录 |  |
| `app-api-modules-ai-import-route-ts-2` | 未配置 n8n 团本解析工作流（N8N_MODULE_PARSE_URL），也没有配置 DEEPSEEK_API_KEY；管理员请在部署环境中配置后重启服务 |  |
| `app-api-modules-ai-import-route-ts-3` | 请求格式不合法 |  |
...
| `app-api-modules-ai-import-route-ts-9` | 未知错误 |  |
| `app-api-modules-ai-import-route-ts-10` | 任务已创建，正在解析素材… |  |
| `app-api-modules-ai-import-route-ts-11` | 缺少 jobId |  |
...
| ID | 原文 | 你的修改 |
|---|---|---|
| `app-api-modules-import-route-ts-1` | 未登录 |  |
| `app-api-modules-import-route-ts-2` | 请求格式不合法 |  |
...
| `app-api-register-route-ts-6` | 参数不合法 |  |
...
| ID | 原文 | 你的修改 |
|---|---|---|
| `app-api-upload-route-ts-1` | 未登录 |  |
| `app-api-upload-route-ts-2` | 请求格式不合法 |  |
...
| `app-cards-page-tsx-3` | 卡属于你自己，可带进任意房间（需 KP 审核）；也可以共享为模板供其他用户复制 |  |
...
| `app-cards-page-tsx-10` | 其他用户共享的模板卡；复制后进入你的卡库 |  |
...
| `app-characters-id-page-tsx-4` | 这张卡没有武器或随身物品记录。 |  |
...
| `app-characters-id-page-tsx-10` | 可按类型、来源与局筛选；属性 / 技能 / SAN 记录支持编辑或撤销，撤销后不再计入成长汇总。 |  |
...
| `app-characters-import-page-tsx-3` | 支持「COC7 空白卡」系列的「人物卡」工作表。导入后进入你的个人角色库； 带进房间仍然走 KP 审核流程。 |  |
| `app-characters-import-page-tsx-4` | 选择 .xlsx 文件 |  |
| `app-characters-import-page-tsx-5` | 解析并导入 |  |
| `app-characters-import-page-tsx-6` | 目前导入范围：基础信息、九项属性、职业序号、技能（初始 / 成长 / 职业 / 兴趣）、信用评级、武器。 |  |
| `app-characters-import-page-tsx-7` | 导入后若发现技能缺失，通常是因为该技能不在当前规则包中，后续会在规则包补全时自动恢复显示。 |  |
...
| `app-characters-page-tsx-3` | 角色属于你自己，可带进任意房间（需 KP 审核） |  |
...
| `app-history-gameid-page-tsx-13` | 本局快照 |  |
| `app-history-gameid-page-tsx-14` | 历史数据 |  |
...
| `app-history-gameid-page-tsx-19` | 旗标 |  |
| `app-history-gameid-page-tsx-20` | 计数器 |  |
| `app-history-gameid-page-tsx-21` | 自定义 |  |
...
| `app-layout-tsx-2` | COC7 兼容的东方 Project 线上跑团平台 |  |
...
| `app-modules-moduleid-page-tsx-20` | Markdown 正文（仅 KP / 作者可见） |  |
...
| `app-modules-mine-page-tsx-3` | 你创建或导入的团本。只有你可以编辑和发布它们。 |  |
...
| `app-modules-mine-page-tsx-8` | 生成标准 14 章节模板，创建后再编辑内容和发布。 |  |
...
| `app-modules-page-tsx-3` | 所有已发布的团本。这里只展示公开预览字段，完整内容由各房间 KP 在团本管理页查看。 |  |
...
| `app-page-tsx-2` | 房间已解散，相关数据已删除。 |  |
| `app-page-tsx-3` | 只有房主可以解散房间。 |  |
| `app-page-tsx-4` | 房间已归档，仍保留历史数据。 |  |
...
| `app-page-tsx-21` | 邀请码 |  |
| `app-page-tsx-22` | 加入 |  |
| `app-page-tsx-23` | 向 KP 索取房间邀请码，输入后即可进入准备页或跑团页。 |  |
...
| `app-rooms-id-combat-combatid-page-tsx-2` | 战斗逻辑与快照仍保存在原系统中 |  |
...
| `app-rooms-id-combat-new-page-tsx-3` | 本房已关闭玩家发起战斗申请的开关。 |  |
| `app-rooms-id-combat-new-page-tsx-4` | 同一个角色只能选一边；已选我方的单位不会再允许选敌方。 |  |
| `app-rooms-id-combat-new-page-tsx-5` | 提交后 KP 会在审批页选择敌方单位。 |  |
...
| `app-rooms-id-combat-requests-requestid-page-tsx-3` | 申请中没有可识别单位，可能已被删除。 |  |
...
| `app-rooms-id-end-page-tsx-3` | 建议先确认本局成长与奖励，再结束。结束后房间回到准备页，角色、物品与成长记录都会保留。 |  |
| `app-rooms-id-end-page-tsx-4` | 当前没有进行中的局 |  |
| `app-rooms-id-end-page-tsx-5` | 房间状态可能卡在 PLAYING / COMBAT / PAUSED，但数据库里没有可结束的 Game。 点击下方按钮会把房间直接重置为 LOBBY，并关闭残留战斗。 |  |
| `app-rooms-id-end-page-tsx-6` | 结束并重置房间 |  |
| `app-rooms-id-end-page-tsx-7` | 成长 / 奖励数据不合法，请检查目标、数值与角色。属性 / 技能 / SAN 的数值变化必须是非零整数。 |  |
| `app-rooms-id-end-page-tsx-8` | 当前局状态或角色不匹配，无法写入成长。 |  |
| `app-rooms-id-end-page-tsx-9` | 房间 |  |
| `app-rooms-id-end-page-tsx-10` | 本局 |  |
| `app-rooms-id-end-page-tsx-11` | 团本快照 |  |
| `app-rooms-id-end-page-tsx-12` | 角色 / 成长 |  |
| `app-rooms-id-end-page-tsx-13` | 成长点确认 |  |
| `app-rooms-id-end-page-tsx-14` | CoC 幕间成长检定：对每个待检定技能掷 1d100；结果大于当前技能值，或落在 96-100 时，技能 +1d10。 |  |
...
| `app-rooms-id-end-page-tsx-37` | 成长检定完成：有技能成功提升，已写入成长记录。 |  |
...
| `app-rooms-id-end-page-tsx-45` | 已锁定开局快照 |  |
| `app-rooms-id-end-page-tsx-46` | 旧局：未生成快照 |  |
...
| `app-rooms-id-modules-moduleid-page-tsx-4` | 空白团本已创建，可以开始编辑标题、简介与正文。 |  |
| `app-rooms-id-modules-moduleid-page-tsx-5` | 该团本仍被进行中的局使用，不能删除。请先结束本局。 |  |
| `app-rooms-id-modules-moduleid-page-tsx-6` | 标题不能为空。 |  |
| `app-rooms-id-modules-moduleid-page-tsx-7` | 该团本已应用到某个房间的准备预设。请先在对应房间换预设或删除预设对象，再删除团本。 |  |
...
| `app-rooms-id-modules-moduleid-page-tsx-14` | Markdown 正文 |  |
...
| `app-rooms-id-modules-moduleid-page-tsx-19` | 地图、图片、手书与附件仅 KP / 团本作者可见。玩家只会看到公开元信息与 KP 主动分享的线索。 |  |
...
| `app-rooms-id-modules-page-tsx-4` | 可以新建带标准 14 章节的空白团本，也可以直接导入 `.md` / `.zip` 标准包。 |  |
...
| `app-rooms-id-npcs-new-page-tsx-3` | 从预设直接加入，或按本房规则自建。生成的是本场专属卡，不会进入个人卡库。 |  |
...
| `app-rooms-id-npcs-new-page-tsx-15` | 技能（每行一个，格式 技能ID:数值） |  |
| `app-rooms-id-npcs-new-page-tsx-16` | 查看本包技能 ID |  |
...
| `app-rooms-id-page-tsx-5` | 团本编辑与素材 |  |
| `app-rooms-id-page-tsx-6` | 房间已归档，仅保留历史数据与只读视图；发言、掷骰和战斗操作已停止。 |  |
| `app-rooms-id-page-tsx-7` | KP 分屏模式：左侧为准备区（场景切换、线索公布），右侧为玩家实际看到的房间视角。 |  |
| `app-rooms-id-page-tsx-8` | 当前没有可用的局内状态，暂时无法进入 KP 准备区。 |  |
| `app-rooms-id-page-tsx-9` | 房间视角（与普通玩家一致） |  |
| `app-rooms-id-page-tsx-10` | 此区域不包含 KP 专属控件 |  |
| `app-rooms-id-page-tsx-11` | 场景 |  |
| `app-rooms-id-page-tsx-12` | 当前激活 |  |
| `app-rooms-id-page-tsx-13` | 房间状态异常 |  |
| `app-rooms-id-page-tsx-14` | 本局： |  |
| `app-rooms-id-page-tsx-15` | 当前没有进行中的局，但房间状态不是 LOBBY。可以结束并重置房间。 |  |
| `app-rooms-id-page-tsx-16` | 暂停会保存当前状态并返回准备页；继续时全员需要重新准备。 |  |
...
| `app-rooms-id-prepare-page-tsx-7` | 每名 PL 至少需要一张审核通过的角色卡才能开始。 |  |
| `app-rooms-id-prepare-page-tsx-8` | 存在没有通过角色审核的 PL，暂时不能开始。 |  |
| `app-rooms-id-prepare-page-tsx-9` | 当前没有可继续的局。 |  |
| `app-rooms-id-prepare-page-tsx-10` | 当前有一个暂停中的局。全员准备后，KP 点击“继续跑团”读取上次进度。 |  |
...
| `app-rooms-id-prepare-page-tsx-14` | 可以前往团本管理导入 / 创建房间团本，也可以从团本广场选择已发布团本。 |  |
| `app-rooms-id-prepare-page-tsx-15` | 背景 |  |
| `app-rooms-id-prepare-page-tsx-16` | 职业推荐 |  |
...
| `app-rooms-id-prepare-page-tsx-21` | 点击后会从只读模板克隆：章节、场景地图、NPC/Boss 卡、武器/物品/证物卡、线索、遭遇与魔法规则。 换预设时，上一次预设生成的房间对象会整批替换；玩家自己创建的内容不受影响。 |  |
| `app-rooms-id-prepare-page-tsx-22` | 本局还未应用所选团本预设，请先点击「应用团本预设到房间」。 |  |
| `app-rooms-id-prepare-page-tsx-23` | 团本选择已保存，全员可见。 |  |
| `app-rooms-id-prepare-page-tsx-24` | 由 n8n 工作流 / 团本结构化数据提前整理。开启后，本局规则包会纳入这些法术，战斗中可消耗 MP/SAN 施放。 |  |
...
| `app-rooms-id-prepare-page-tsx-35` | 角色库里没有可带入本房的角色；可以先去「我的角色」新建 / 导入，再回本页提交。 |  |
...
| `app-rooms-id-prepare-page-tsx-48` | 还没有激活的场景。KP 可先到「场景 / 地图」创建并切换场景，再回来布置 Token、墙体与灯光。 |  |
...
| `app-rooms-id-prepare-page-tsx-73` |  / 场景 searchParams.scenes ?? |  |
| `app-rooms-id-prepare-page-tsx-74` |  / 武器物品 searchParams.items ?? |  |
| `app-rooms-id-prepare-page-tsx-75` |  / 线索证物 searchParams.clues ?? |  |
| `app-rooms-id-prepare-page-tsx-76` |  / 遭遇 searchParams.encounters ?? |  |
...
| `app-rooms-id-scenes-page-tsx-3` | KP 可创建场景、上传地图、放置角色与 NPC Token；Token 图片自动取角色卡立绘 / 头像，未配置时显示默认占位，不再单独上传。 |  |
...
| `app-rooms-id-scenes-page-tsx-10` | 还没有场景。KP 创建场景后，跑团页会显示战术棋盘。 |  |
...
| `app-rooms-id-scenes-page-tsx-33` | 场景页可管理图层图片；墙体 / 灯光 / 战雾在跑团页战术棋盘上操作。 |  |
...
| `app-rooms-id-scenes-page-tsx-67` |  个场景 / searchParams.encounters ?? |  |
...
| `app-rooms-new-page-tsx-3` | 开团前一次性锁定规则；KP 之后仍可覆盖，但会留下审计记录 |  |
| `app-rooms-new-page-tsx-4` | 请填写房间名后再创建。 |  |
| `app-rooms-new-page-tsx-5` | 车卡方式不合法，请重新选择。 |  |
| `app-rooms-new-page-tsx-6` | 创建房间失败，请重试；如果持续失败，请刷新页面或重启 dev server。 |  |

## `components/admin/RulePackConfigEditor.tsx`

| ID | 原文 | 你的修改 |
|---|---|---|
| `components-admin-rulepackconfigeditor-tsx-1` | JSON 不合法 |  |
...
| `components-admin-rulepackconfigeditor-tsx-5` | 启用魔法规则（magic.enabled） |  |
| `components-admin-rulepackconfigeditor-tsx-6` | 技能 / 种族 / 战斗 / 法术等复杂结构请切到「JSON 编辑」修改。表单只覆盖系统与常用开关，不会动其它字段。 |  |
| `components-admin-rulepackconfigeditor-tsx-7` | JSON 不合法，无法用表单编辑，请先在 JSON 模式修正。 |  |
| `components-admin-rulepackconfigeditor-tsx-8` | 表单编辑 |  |
| `components-admin-rulepackconfigeditor-tsx-9` | JSON 编辑 |  |
...
| `components-danmaku-danmakupatterneditor-tsx-2` | 纯视觉。展开型符卡循环播放到被击破，消费型符卡播放一次；不参与战斗判定。 |  |
| `components-danmaku-danmakupatterneditor-tsx-3` | 换一组随机种子 |  |
| `components-danmaku-danmakupatterneditor-tsx-4` | 预览 · 60fps |  |
| `components-danmaku-danmakupatterneditor-tsx-5` | 添加图案（最多 3 层叠加） |  |
...
| `components-danmaku-danmakupatterneditor-tsx-18` | 加色发光（更华丽，子弹多时略吃性能） |  |
...
| ID | 原文 | 你的修改 |
|---|---|---|
| `components-danmaku-danmakustage-tsx-1` | 纯视觉演出 · 不参与判定 |  |
...
| `components-layout-usermenu-tsx-10` | 支持 PNG / JPEG / WebP，最大 8 MB；上传后自动裁剪为正方形。 |  |
...
| `components-layout-usermenu-tsx-17` | 网络错误，上传失败 |  |
...
| `components-module-aimoduleimporter-tsx-7` | 模型（n8n 工作流会透传给 DeepSeek；涉及图片素材时推荐 deepseek-flash） |  |
| `components-module-aimoduleimporter-tsx-8` | 使用后台/环境默认（默认 deepseek-flash，支持 vision） |  |
| `components-module-aimoduleimporter-tsx-9` | deepseek-flash（推荐 · 支持图片视觉） |  |
| `components-module-aimoduleimporter-tsx-10` | deepseek-v4-pro（文本推理） |  |
| `components-module-aimoduleimporter-tsx-11` | 给 n8n 工作流的额外要求（可选） |  |
| `components-module-aimoduleimporter-tsx-12` | 任务在后台运行，页面每 2-3 秒刷新进度；公网穿透断开或关闭页面也不会中断，生成完成后会出现在「我的团本」。 |  |
...
| `components-module-aimoduleimporter-tsx-16` | 任务仍在进行，但等待时间过长；请稍后重新发起或到「我的团本」查看。 |  |
| `components-module-aimoduleimporter-tsx-17` | 请求失败：网络中断或服务已重启，请稍后用同样素材重试。 |  |
| `components-module-aimoduleimporter-tsx-18` | 例：重点整合 NPC 关系图；把地图截图对应写成场景；偏向轻松搞笑风格…… |  |
| `components-module-aimoduleimporter-tsx-19` | n8n 工作流解析中… |  |
| `components-module-aimoduleimporter-tsx-20` | n8n 工作流解析团本 |  |
| `components-module-aimoduleimporter-tsx-21` | （模型 |  |
| `components-module-aimoduleimporter-tsx-22` | ，文本段 |  |
| `components-module-aimoduleimporter-tsx-23` | ，图片 |  |
| `components-module-aimoduleimporter-tsx-24` | ，调用 |  |
| `components-module-aimoduleimporter-tsx-25` | 次） |  |
...
| `components-module-magiceffectcomposer-tsx-4` | JSON 合法，已同步到表单。 |  |
...
| `components-module-magiceffectcomposer-tsx-10` | 查看当前组合 JSON |  |
| `components-module-magiceffectcomposer-tsx-11` | JSON 必须是效果数组，例如 [ \"type\": \"DAMAGE\", \"amount\": \"1d6\" ] |  |
| `components-module-magiceffectcomposer-tsx-12` | 有无法识别的效果（type 不在 14 种基础效果里），已忽略这些项。 |  |
| `components-module-magiceffectcomposer-tsx-13` | JSON 解析失败 |  |
| `components-module-magiceffectcomposer-tsx-14` | 表单 |  |
...
| `components-module-moduleassetactions-tsx-5` | 确定删除这个资源吗？引用它的正文可能需要手动修正。 |  |
...
| `components-module-moduleassetupload-tsx-4` | 网络错误，上传失败 |  |
| `components-module-moduleassetupload-tsx-5` | 资源相对路径，可直接上传 |  |
...
| `components-module-moduleentityeditors-tsx-7` | 技能（SKILL:值，逗号分隔） |  |
| `components-module-moduleentityeditors-tsx-8` | Token 图路径（留空则用默认占位） |  |
...
| `components-module-moduleentityeditors-tsx-14` | 技能 ID |  |
...
| `components-module-moduleentityeditors-tsx-19` | 关联证物 id（可选） |  |
...
| `components-module-moduleentityeditors-tsx-36` | SELF 自己 |  |
| `components-module-moduleentityeditors-tsx-37` | ONE 单体 |  |
| `components-module-moduleentityeditors-tsx-38` | ALL 全体 |  |
| `components-module-moduleentityeditors-tsx-39` | 目标阵营（留空自动推断） |  |
| `components-module-moduleentityeditors-tsx-40` | 自动 |  |
| `components-module-moduleentityeditors-tsx-41` | ALLY 友方 |  |
| `components-module-moduleentityeditors-tsx-42` | ENEMY 敌方 |  |
| `components-module-moduleentityeditors-tsx-43` | ANY 任意 |  |
| `components-module-moduleentityeditors-tsx-44` | 结构化内容编辑 |  |
| `components-module-moduleentityeditors-tsx-45` | 直接编辑角色 / 物品 / 线索 / 场景。保存后会同步写入标准 Markdown 的结构化块与只读模板，应用团本预设时生效。 |  |
...
| ID | 原文 | 你的修改 |
|---|---|---|
| `components-module-moduleimporter-tsx-1` | 选择 .md 或 .zip 标准团本包 |  |
| `components-module-moduleimporter-tsx-2` | 标准包导入 |  |
| `components-module-moduleimporter-tsx-3` | n8n 工作流解析 |  |
...
| `components-module-roompresetcontentpanel-tsx-2` | 本团本还没有应用到当前房间。先回准备页点击「应用团本预设到房间」，NPC / 线索 / 场景才会生成并在这里编辑。 |  |
| `components-module-roompresetcontentpanel-tsx-3` | 预设内容编辑（KP） |  |
| `components-module-roompresetcontentpanel-tsx-4` | 这些对象来自当前房间已应用的团本预设。编辑只影响本房间，不会修改团本模板。 |  |
...
| `components-module-roompresetcontentpanel-tsx-11` | 场景背景与结构请在团本编辑器中维护 |  |
...
| `components-room-archiveroombutton-tsx-3` | 」吗？归档后房间不再出现在进行中列表，但历史数据会保留。 |  |
...
| `components-room-cardbuilder-tsx-4` | 副标题（可留空） |  |
| `components-room-cardbuilder-tsx-5` | 说明（可留空） |  |
...
| `components-room-cardbuilder-tsx-10` | 符卡说明（战斗日志展示用） |  |
...
| `components-room-cardbuilder-tsx-18` | 武器类型（伤害 / 射程 / 使用技能由系统自动带出） |  |
...
| `components-room-cardbuilder-tsx-24` | 魔法、道具、符卡、武器共用同一套效果；数值各自填写。 |  |
...
| `components-room-cardbuilder-tsx-32` | 保存后进入房间卡池，所有成员可见 |  |
...
| ID | 原文 | 你的修改 |
|---|---|---|
| `components-room-characterbuilder-tsx-1` | 第一页 · 角色属性与技能（必填） |  |
| `components-room-characterbuilder-tsx-2` | 第二页 · 人物故事 / 财产 / 物品（选填） |  |
...
| `components-room-characterbuilder-tsx-13` | 含自选技能位，自选部分请按 KP 审核意见分配。 |  |
| `components-room-characterbuilder-tsx-14` | 本职空位：先选择技能，选中后才会变为「本职」并可用职业点；不选则按兴趣技能处理。 |  |
| `components-room-characterbuilder-tsx-15` | 先掷一次 5 组属性；鼠标点击下方结果里的「选用」后，9 维才会锁定为那一组。 |  |
...
| `components-room-characterbuilder-tsx-23` | 年龄补正已确认并锁定；最终属性按上方结果只读展示 |  |
| `components-room-characterbuilder-tsx-24` | 重新分配 |  |
| `components-room-characterbuilder-tsx-25` | 衍生属性（实时计算） |  |
| `components-room-characterbuilder-tsx-26` | 技能分配 |  |
| `components-room-characterbuilder-tsx-27` | 本职用职业点，其余用兴趣点，同一技能不能混用。 |  |
| `components-room-characterbuilder-tsx-28` | 职业点剩余 |  |
| `components-room-characterbuilder-tsx-29` | 兴趣点剩余 |  |
| `components-room-characterbuilder-tsx-30` | 还没选择职业。当前所有技能加点都按兴趣点计算，不能使用职业点。 |  |
...
| `components-room-characterbuilder-tsx-42` | 第一页必须填完整；完成后进入第二页（人物故事 / 财产 / 持有物品，均可留空）。 |  |
| `components-room-characterbuilder-tsx-43` | 下一步：人物故事 / 财产 / 物品 |  |
...
| `components-room-characterbuilder-tsx-54` | 调查员经历（JSON 数组，选填） |  |
| `components-room-characterbuilder-tsx-55` | 神话相关（JSON 数组，选填） |  |
| `components-room-characterbuilder-tsx-56` | 调查员伙伴（JSON 数组，选填） |  |
| `components-room-characterbuilder-tsx-57` | 法术一览（JSON 数组，选填；name 会作为持有法术） |  |
| `components-room-characterbuilder-tsx-58` | 财产（选填） |  |
| `components-room-characterbuilder-tsx-59` | 持有物品（选填） |  |
| `components-room-characterbuilder-tsx-60` | 从卡库选择；卡牌属性统一在卡牌编辑页维护。 |  |
...
| `components-room-characterbuilder-tsx-101` | 天命 5 只能掷一次；掷完后从 5 组结果中选择 1 组，不能手动修改属性。 |  |
| `components-room-characterbuilder-tsx-102` | 直接在九维输入框里填写数值，系统实时校验总和与单项范围。 |  |
| `components-room-characterbuilder-tsx-103` | 直接填写九维属性；保存时由服务端校验范围。 |  |
...
| `components-room-characterbuilder-tsx-111` | 组；只能掷一次，但可以重新选用其他组。 |  |
...
| `components-room-characterbuilder-tsx-125` | 搜索技能名 / ID |  |
...
| `components-room-clueadmincontrols-tsx-8` | 勾选后会替换当前分享名单；全部取消表示撤回转发。 |  |
...
| ID | 原文 | 你的修改 |
|---|---|---|
| `components-room-combatboard-tsx-1` | 攻击技能与实际伤害；伤害只读，由服务端装备数据生成。 */ readonly attackOptionsByParticipant: Readonly |  |
| `components-room-combatboard-tsx-2` | 已装备的符卡（仅 TOUHOU）。 */ readonly spellCardsByParticipant: Readonly |  |
| `components-room-combatboard-tsx-3` | 已装备、可在战斗中使用的道具卡。 */ readonly itemOptionsByParticipant: Readonly |  |
| `components-room-combatboard-tsx-4` | 立绘 / 头像 URL。 */ readonly portraits: Readonly |  |
...
| `components-room-combatboard-tsx-10` | 同地点冲突：追上不会自动掉血。攻击消耗 1 行动点，按普通攻击检定结算，目标可以闪避 / 反击。 |  |
...
| `components-room-combatboard-tsx-40` | KP 强制结算（未行动按跳过） |  |
...
| `components-room-combatboard-tsx-49` | 无法获取连接票据，请刷新页面 |  |
...
| `components-room-combatboard-tsx-55` | 连接已断开，请刷新页面后重试 |  |
...
| `components-room-combatboard-tsx-87` | 轮 · tick |  |
...
| `components-room-combatboard-tsx-94` | HP ？？？ · 数值未公开 |  |
...
| `components-room-combatboard-tsx-105` | 行动；你没有可操作单位，只能旁观。 |  |
...
| `components-room-combatboard-tsx-114` | 展开型：生成独立 HP，被击破时会清弹；弹幕演出循环到被击破。 |  |
| `components-room-combatboard-tsx-115` | 消费型：发动一次并附带消弹；弹幕演出只播放一次。 |  |
| `components-room-combatboard-tsx-116` | 独立 HP 约 |  |
| `components-room-combatboard-tsx-117` | （自己） |  |
| `components-room-combatboard-tsx-118` | 自己 |  |
| `components-room-combatboard-tsx-119` | 全体敌方（AOE，所有目标都要应对） |  |
...
| `components-room-combatboard-tsx-128` | 伤害由角色实际装备决定，不可修改 |  |
...
| `components-room-disbandroombutton-tsx-3` | 」吗？房间成员、聊天、战斗、团本关联数据都会被删除，且不可恢复。 |  |
...
| `components-room-endgamepanel-tsx-2` | 可一次给多名角色录入结束奖励；留空则直接结束本局。属性 / 技能 / SAN 会同步到基础角色卡，并写入成长记录。 |  |
| `components-room-endgamepanel-tsx-3` | + 添加一条 |  |
| `components-room-endgamepanel-tsx-4` | 暂无批量成长。可以直接确认结束，或先添加奖励。 |  |
...
| `components-room-endgamepanel-tsx-11` | 确认后：Game 置为 ENDED，房间回到 LOBBY，全员取消准备。角色、物品、成长记录跨局保留。 |  |
...
| `components-room-endgamepanel-tsx-19` | 技能 id，例如 FIGHTING_BRAWL |  |
| `components-room-endgamepanel-tsx-20` | 属性键，例如 int / edu / luck |  |
| `components-room-endgamepanel-tsx-21` | 物品名 |  |
| `components-room-endgamepanel-tsx-22` | 关系名 |  |
| `components-room-endgamepanel-tsx-23` | 奖励 / 成长说明键 |  |
...
| `components-room-kpbgmpanel-tsx-2` | 粘贴网易云音乐或 QQ 音乐链接，房间内所有成员会加载同一个播放器。 |  |
| `components-room-kpbgmpanel-tsx-3` | 全房间同步 |  |
| `components-room-kpbgmpanel-tsx-4` | 解析并播放 |  |
| `components-room-kpbgmpanel-tsx-5` | 受浏览器自动播放策略限制，玩家端可能需要在播放器上点一次播放；KP 也会在右侧房间视角里看到同一个播放器。 |  |
...
| `components-room-kpbgmpanel-tsx-10` | BGM 已开始播放，并已同步给全房间。 |  |
| `components-room-kpbgmpanel-tsx-11` | BGM 已停止，玩家端也会同步停止。 |  |
| `components-room-kpbgmpanel-tsx-12` | 无法解析该链接。支持网易云音乐完整链接 / 短链，以及 QQ 音乐单曲完整链接 / App 分享短链；QQ 歌单暂不支持。 |  |
| `components-room-kpbgmpanel-tsx-13` | 当前没有可操作的对局，无法设置 BGM。 |  |
...
| `components-room-kppreppanel-tsx-24` | KP 直接选择双方单位进入战斗，不需要玩家申请，也不需要审批。 |  |
...
| `components-room-kppreppanel-tsx-28` | 对所有成员公开（默认仅 KP 可见） |  |
| `components-room-kppreppanel-tsx-29` | 发布线索 |  |
| `components-room-kppreppanel-tsx-30` | 还没有线索。 |  |
| `components-room-kppreppanel-tsx-31` | ) : ( // 线索多时用可滚动 + 折叠行，避免整块面板被撑得很长。 |  |
...
| `components-room-kpvalueeditor-tsx-2` | 任意阶段可用：HP / MP / SAN / DP、九项属性、技能。非战斗写入角色卡 / NPC 卡， 战斗中同时实时同步到战斗单位。留空表示不修改。 |  |
| `components-room-kpvalueeditor-tsx-3` | 目标单位 |  |
| `components-room-kpvalueeditor-tsx-4` | 属性（留空不改） |  |
| `components-room-kpvalueeditor-tsx-5` | 技能（ID:数值，每行一项） |  |
| `components-room-kpvalueeditor-tsx-6` | 应用数值 |  |
| `components-room-kpvalueeditor-tsx-7` | 重新读取实时值 |  |
...
| ID | 原文 | 你的修改 |
|---|---|---|
| `components-room-npceditform-tsx-1` | 这张 NPC 卡的属性数据不完整，暂时无法编辑。 |  |
...
| `components-room-npceditform-tsx-9` | 技能（示例：FIGHTING_BRAWL:60, DODGE:40） |  |
...
| `components-room-playerdashboard-tsx-4` | 状态（buff / debuff） |  |
...
| `components-room-roomadvancementpanel-tsx-2` | 成长记录会标注来源，并单独保存；属性 / 技能 / SAN 变动会同步到角色卡。 |  |
| `components-room-roomadvancementpanel-tsx-3` | 待检定成长点（CoC 幕间：d100 大于技能值或 96-100 时 +1d10） |  |
...
| `components-room-roomadvancementpanel-tsx-16` | 目标 / 说明键 |  |
...
| `components-room-roomadvancementpanel-tsx-36` | 成长点数据不合法，或该技能不在当前规则包中。 |  |
| `components-room-roomadvancementpanel-tsx-37` | 当前局状态不允许进行成长检定。 |  |
| `components-room-roomadvancementpanel-tsx-38` | 操作失败，请稍后重试。 |  |
| `components-room-roomadvancementpanel-tsx-39` | attr / skill id / 物品名 |  |
...
| `components-room-roomcardeditform-tsx-6` | stats JSON（伤害、射程、技能等） |  |
...
| `components-room-roomcombatpanel-tsx-2` | 进入战斗页面 |  |
...
| `components-room-roomgamestatepanel-tsx-2` | 局内状态已保存，并已同步给在线成员。 |  |
...
| `components-room-roomgamestatepanel-tsx-8` | 当前章节（ModuleChapter 结构化绑定） |  |
| `components-room-roomgamestatepanel-tsx-9` | 未设置 |  |
| `components-room-roomgamestatepanel-tsx-10` | 当前场景（房间 Scene 结构化绑定） |  |
| `components-room-roomgamestatepanel-tsx-11` | 保存时将当前场景切换为激活场景（影响战术棋盘） |  |
| `components-room-roomgamestatepanel-tsx-12` | 旗标 JSON |  |
| `components-room-roomgamestatepanel-tsx-13` | 计数器 JSON |  |
| `components-room-roomgamestatepanel-tsx-14` | 自定义 JSON |  |
| `components-room-roomgamestatepanel-tsx-15` | 保存局内状态 |  |
| `components-room-roomgamestatepanel-tsx-16` | 状态已被其他操作更新，请刷新后重试。 |  |
| `components-room-roomgamestatepanel-tsx-17` | 旗标必须是合法的 JSON 对象。 |  |
| `components-room-roomgamestatepanel-tsx-18` | 计数器必须是合法的 JSON 对象。 |  |
| `components-room-roomgamestatepanel-tsx-19` | 自定义状态必须是合法的 JSON 对象。 |  |
...
| `components-room-roomgamestatepanel-tsx-26` | 团本里用 module-encounter 块定义遭遇 |  |
...
| `components-room-roominfopanel-tsx-2` | 线索由 KP 发布；已发现线索会记录到你的账号。笔记只对本人可见，KP 可追加 KP 专属笔记。 |  |
| `components-room-roominfopanel-tsx-3` | 线索已发布 |  |
| `components-room-roominfopanel-tsx-4` | 已标记发现 |  |
| `components-room-roominfopanel-tsx-5` | 图片上传失败（仅支持 PNG / JPEG / WebP，且不超过 8MB）。 |  |
...
| `components-room-roominfopanel-tsx-12` | 对所有成员公开（默认仅 KP 可见） |  |
...
| `components-room-roominfopanel-tsx-18` | 本局团本没有 handout 资源。 |  |
...
| `components-room-roomnpcpanel-tsx-20` | 默认对玩家隐藏；点击「公开属性」后玩家才能看到名字、属性与技能。 |  |
...
| `components-room-roomplay-tsx-6` | 选择对象 |  |
...
| `components-room-roomplay-tsx-15` | 无法获取连接票据，请刷新页面 |  |
...
| `components-room-roomplay-tsx-21` | 连接已断开，请刷新页面后重试 |  |
| `components-room-roomplay-tsx-22` | 请输入骰子表达式，例如 1d100 |  |
...
| `components-room-roomplay-tsx-30` | 输入技能名 / ID 检索 |  |
| `components-room-roomplay-tsx-31` | 取消收藏 |  |
| `components-room-roomplay-tsx-32` | 收藏技能 |  |
| `components-room-roomplay-tsx-33` | 1d100 2d6+3（回车也可掷骰） |  |
...
| `components-room-roomsetupform-tsx-3` | 房间名必填；不填会被服务端退回本页。 |  |
| `components-room-roomsetupform-tsx-4` | 模组 |  |
| `components-room-roomsetupform-tsx-5` | 决定技能表、种族与可用卡池。角色卡和卡牌不能跨模组使用。 |  |
| `components-room-roomsetupform-tsx-6` | 背景年代 |  |
| `components-room-roomsetupform-tsx-7` | 仅 COC7 生效。年代会过滤职业与本职业技能，并写入房间内创建的角色。 |  |
| `components-room-roomsetupform-tsx-8` | 东方模组使用幻想乡年代规则，不设置现代 / 1920 年代。 |  |
...
| `components-room-roomsetupform-tsx-13` | 战斗中允许发生的事件 |  |
| `components-room-roomsetupform-tsx-14` | 默认全部开启，勾选「禁用」则本房不生效 |  |
| `components-room-roomsetupform-tsx-15` | 禁用 |  |
| `components-room-roomsetupform-tsx-16` | 玩家角色可见性 |  |
| `components-room-roomsetupform-tsx-17` | 默认玩家之间可见彼此角色属性；选择“私密”后，玩家只能看到自己的角色卡，KP 始终可见全部。 |  |
...
| `components-room-roomsetupform-tsx-21` | 开启后 PL 可发起战斗申请，由 KP 审批；KP 始终可直接发起 |  |
...
| `components-room-sceneboard-tsx-10` | 当前场景还没有配置地图；先放置 Token 会自动建立空白地图，KP 之后再补背景图。 |  |
...
| `components-room-sceneboard-tsx-14` | 团本和房间还没有可用图片，先上传或到团本编辑器添加素材。 |  |
| `components-room-sceneboard-tsx-15` | 应用背景 |  |
| `components-room-sceneboard-tsx-16` | 共享战争视野（双向：对方也会看到你的视野） |  |
...
| `components-upload-imageupload-tsx-2` | 网络错误，上传失败 |  |
...
| ID | 原文 | 你的修改 |
|---|---|---|
| `shared-bgm-ts-1` | 无法识别网易云音乐链接类型 |  |
| `shared-bgm-ts-2` | 没有在链接里找到有效的网易云音乐 id |  |
| `shared-bgm-ts-3` | QQ 音乐歌曲 id 格式不正确 |  |
| `shared-bgm-ts-4` | 暂时无法识别这种 QQ 音乐链接 |  |
...
| `shared-danmaku-presets-ts-28` | $DANMAKU_LAYER_LABELS[layer.type] · $layer.count 发 / $layer.interval 帧 |  |

## `shared/danmaku/schema.ts`

| ID | 原文 | 你的修改 |
|---|---|---|
| `shared-danmaku-schema-ts-1` | 颜色格式应为 #RRGGBB |  |
...
| `shared-magic-effects-ts-3` | 持续行动轮次 |  |
| `shared-magic-effects-ts-4` | 0 = 耗尽 / 战斗结束 |  |
| `shared-magic-effects-ts-5` | 持续行动次数 |  |
| `shared-magic-effects-ts-6` | 例如 1 |  |
| `shared-magic-effects-ts-7` | 伤害 |  |
| `shared-magic-effects-ts-8` | 造成伤害，走伤害管线与护甲 |  |
...
| `shared-magic-effects-ts-14` | 扣除目标 MP，同量转移给施法者 |  |
...
| `shared-magic-effects-ts-20` | 施加规则包中定义的状态 |  |
| `shared-magic-effects-ts-21` | 状态 key |  |
| `shared-magic-effects-ts-22` | 例如 HASTE |  |
| `shared-magic-effects-ts-23` | 层数 |  |
| `shared-magic-effects-ts-24` | 护甲 |  |
| `shared-magic-effects-ts-25` | 获得护甲池，1:1 吸收伤害，按行动轮次到期 |  |
| `shared-magic-effects-ts-26` | 召唤 |  |
| `shared-magic-effects-ts-27` | 按独立 NPC 卡生成参战单位；无卡走通用兜底 |  |
| `shared-magic-effects-ts-28` | 召唤物名字 |  |
| `shared-magic-effects-ts-29` | 例如 次元蹒跚者 |  |
| `shared-magic-effects-ts-30` | 召唤物 |  |
| `shared-magic-effects-ts-31` | 稳定 key（可选） |  |
| `shared-magic-effects-ts-32` | 用于跨译名匹配 |  |
| `shared-magic-effects-ts-33` | 指定房间 NPC 卡 id（可选） |  |
| `shared-magic-effects-ts-34` | 留空则按名字匹配 |  |
| `shared-magic-effects-ts-35` | 数量 |  |
| `shared-magic-effects-ts-36` | 夺舍 |  |
| `shared-magic-effects-ts-37` | 操纵目标；充能池按战斗轮次 + 被夺舍 Token 移动消耗，耗尽归还控制权 |  |
...
| `shared-magic-effects-ts-43` | 可选分组 key |  |
| `shared-magic-effects-ts-44` | 留空则按法术 id |  |
| `shared-magic-effects-ts-45` | 眩晕 |  |
| `shared-magic-effects-ts-46` | 强制跳过行动 |  |
| `shared-magic-effects-ts-47` | 控制 |  |
| `shared-magic-effects-ts-48` | 净化 |  |
| `shared-magic-effects-ts-49` | 清除状态 / 持续伤害 / 控制；keys 为空时清默认项 |  |
| `shared-magic-effects-ts-50` | 要清除的 key（逗号分隔） |  |
| `shared-magic-effects-ts-51` | 留空 = DOT + STUN + CONTROL |  |
...
| ID | 原文 | 你的修改 |
|---|---|---|
| `shared-occupation-ts-1` | 空位需要选择 |  |
| `shared-occupation-ts-2` | 项，当前 |  |
| `shared-occupation-ts-3` | 空位的候选不包含技能： |  |
| `shared-occupation-ts-4` | 同一个技能不能占用两个空位： |  |
...
| `shared-occupation-ts-26` | ([一二两三四五六七八九十0-9]+)\\s*项[^。；，,]*? |  |
